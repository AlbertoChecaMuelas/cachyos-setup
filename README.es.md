...
> El script funciona para cualquier usuario: `install.sh` detecta automáticamente el usuario actual y configura `/etc/sudoers.d/cachyos-pacman` en consecuencia, sin necesidad de editar nada a mano.
